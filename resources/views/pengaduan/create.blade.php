...
<body class="bg-[#F2FBFF] text-[#185141]">
    ...
    <div class="border-b-4 border-[#185141]">
        ...
        <div class="mt-10 flex w-full justify-center">
                ...
                <button type="submit" class="mt-10 text-white bg-[#40C6A1] hover:bg-[#40A1A1] focus:ring-4 focus:outline-none focus:ring-cyan-300 dark:focus:ring-cyan-800 font-medium rounded-lg text-md px-5 py-2.5 text-center me-2 mb-2">Kirim</button>
            </form>
        </div>
    </div>
