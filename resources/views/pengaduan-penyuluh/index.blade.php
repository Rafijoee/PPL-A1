                ...
                <tbody>
                    ...
                    <tr class="bg-white border-b dark:bg-gray-800 dark:border-gray-700">
                        ...
                        <td class="px-6 py-4">
                            ...
                            <div class="w-1/2 px-2 text-center bg-[#594FB7] rounded-lg text-white">
                                sedang ditindaklanjuti
                            </div>
                            @elseif ($report->handling__statuses_id == 3)
                            <div class="w-1/2 px-2 text-center bg-[#037367] rounded-lg text-white">
                                sudah ditindaklanjuti
                            </div>
                            @else
                            <div class="w-1/2 px-2 text-center bg-[#3197F2] rounded-lg text-white">
                                belum ditindaklanjuti
                            </div>
                            @endif
                        </td>
                        <td class="px-6 py-4">
                            <a href="/dashboard/pengaduan-penyuluh/{{ Crypt::encryptString($report["id"]) }}" class="font-medium text-[#185141] hover:underline">Lihat</a>
                            ...
                            <a href="/dashboard/pengaduan-penyuluh/{{ Crypt::encryptString($report["id"]) }}/edit" class="text-white bg-[#185141] hover:bg-[#26826F] focus:ring-4 focus:outline-none focus:ring-cyan-300 dark:focus:ring-cyan-800 font-medium rounded-lg text-md px-5 py-2.5 text-center me-2 mb-2 ml-3">Buat Aduan</a>
                            @endif
                            @endif
                        </td>
                        @endforeach
