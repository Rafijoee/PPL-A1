    ...
    <div class="p-4 sm:ml-64 mt-16 mb-96 text-justify ">
        ...
        <div class="mt-5" id="tanggapan" style="display: none;">
            ...
            @if ($reports->tanggapan_penyuluh)
                    ...
                    <a href="/dashboard/pengaduan-penyuluh/edit/{{ Crypt::encryptString($reports["id"]) }}" class="text-white bg-gradient-to-r from-cyan-500 to-blue-500 hover:bg-gradient-to-bl focus:ring-4 focus:outline-none focus:ring-cyan-300 dark:focus:ring-cyan-800 font-medium rounded-lg text-md py-2 px-2">Perbarui Tanggapan</a>
                @else
                    <p class="bg-gray-100 text-justify px-5 pt-3 pb-3 rounded-xl mb-5">Belum ada tanggapan, Buatlah tanggapan</p>
                    <a href="/dashboard/pengaduan-penyuluh/edit/{{ Crypt::encryptString($reports["id"]) }}" class="text-white bg-gradient-to-r from-cyan-500 to-blue-500 hover:bg-gradient-to-bl focus:ring-4 focus:outline-none focus:ring-cyan-300 dark:focus:ring-cyan-800 font-medium rounded-lg text-md py-2 px-2">Buat Tanggapan</a>
                @endif
            </div>
