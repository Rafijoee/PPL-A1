@yield('dashboard2')
<aside id="logo-sidebar" class="fixed top-0 left-0 z-40 w-64 h-screen pt-20 transition-transform -translate-x-full bg-[#F2FBFF] border-gray-200 sm:translate-x-0 dark:bg-gray-800 dark:border-gray-700 border-r-[3px]" aria-label="Sidebar">
