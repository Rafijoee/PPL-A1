            ...
            <div class="w-full bg-white bg-opacity-80 p-4 sm:p-8">
                <div class="mx-2 sm:mx-12 my-4 sm:my-8">
                    <div class="mx-2 my-4">
                        ...
                        <input type="text" name="name" id="name" class="mt-2 sm:mt-4 border-none bg-transparent focus:outline-none sm:text-sm block w-full" value="{{$user->name}}">
                    ...
                    <div class="mx-2 my-4">
                        ...
                        <input type="text" name="nik" id="nik" class="mt-2 sm:mt-4 border-none bg-transparent focus:outline-none sm:text-sm block w-full" value="{{$profile->nik}}">
                        <hr class="border-t-2 border-[#185141]">
                        @error('nik')
                        <div class="invalid-feedback text-red-500">
                            {{ $message }}
                    ...
                    <div class="mx-2 my-4">
                        ...
                        <input name="no_hp" id="no_hp" class="mt-2 sm:mt-4 border-none bg-transparent focus:outline-none sm:text-sm block w-full" value="{{$profile->no_hp}}">
                        <hr class="border-t-2 border-[#185141]">
                        @error('no_hp')
                        <div class="invalid-feedback text-red-500">
                            {{ $message }}
                    ...
                    <div class="mx-2 my-4">
                        ...
                        <input name="alamat" id="alamat" class="mt-2 sm:mt-4 border-none bg-transparent focus:outline-none sm:text-sm block w-full" value="{{$profile->alamat}}">
                        <hr class="border-t-2 border-[#185141]">
                        @error('alamat')
                        <div class="invalid-feedback text-red-500">
                            {{ $message }}
