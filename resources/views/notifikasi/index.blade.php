...
<div class="ml-64 mt-20 h-full">
    <div class="bg-white mr-3 border border-blue rounded-2xl">

        <h1 class="font-bold text-4xl">Pengaduan</h1>
        <div id="toast-notification" class="mx-auto  flex items-center max-w-xxl p-4 mr-4 mt-10 text-gray-900 bg-[#F2FBFF] rounded-lg shadow dark:bg-gray-800 dark:text-gray-300" role="alert">
        </div>
