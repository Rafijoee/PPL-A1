...
<body class="bg-[#F2FBFF]">
    <div class="p-4 sm:ml-80 mt-16 mb-96 mx-10">
        ...
        @foreach ($matchingProfiles as $profile_penyuluh)
        <div class="flex flex-col items-center bg-white border border-gray-200 rounded-lg shadow md:flex-row md:max-w-xl mt-12 ">
            ...
            <div class="flex flex-col justify-between p-4 leading-normal">
                ...
                <h5 class="mb-2 text-2xl font-bold tracking-tight text-gray-900 dark:text-white">{{$profile_penyuluh->nama}}</h5>
                ...
                <a href="{{ 'chatify/' . $profile_penyuluh->user_id }}" class=" items-center px-3 py-2 text-sm font-medium text-center text-white bg-[#40C6A1] rounded-lg hover:bg-[#40A1A1] focus:ring-4 focus:outline-none focus:ring-blue-300 dark:bg-[#40A1A1]  dark:hover:bg-[#40A1A1]">Konsultasi Sekarang !</a>
            </div>
        </div>
        @endforeach 
    </div>
