    ...
    <div class="p-4 sm:ml-72 mt-16 mb-96">
        ...
        <div class="mt-10 flex w-full justify-center">
            ...
            @csrf
                ...
                <button type="submit" class="mt-10 w-full text-white bg-[#185141] hover:bg-[#26826F] focus:ring-4 focus:outline-none focus:ring-cyan-300 dark:focus:ring-cyan-800 font-medium rounded-lg text-md px-5 py-2.5 text-center me-2 mb-2">Simpan</button>
            </form>
        </div>
    </div>
    <script>
