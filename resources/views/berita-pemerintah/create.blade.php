    ...
    <div class="p-4 sm:ml-72 mt-16 mb-96">
        ...
        <div class="mt-10 flex w-full justify-center">
            <form class="space-y-4 md:space-y-6 w-2/3" method="post" action="/dashboard/berita-pemerintah" enctype="multipart/form-data">
                ...
                <button type="submit" class="mt-10 w-full text-white bg-[#40C6A1] hover:bg-[#40A1A1] focus:ring-4 focus:outline-none focus:ring-cyan-300 dark:focus:ring-cyan-800 font-medium rounded-lg text-md px-5 py-2.5 text-center me-2 mb-2">Kirim</button>
            </form>
        </div>
    </div>
    <script>
